var AutoDisplayLeyend=function(c)
	...
	if(c!==undefined)
		...
		if(val[0]==val[5]){
			...
			labels.push('<i  style=" background:rgba(252,238,78,1);border-color:rgba(44,104,141,1);"></i> '+numeral((val[2])).format('0,0')+' - '+numeral(val[3]).format('0,0'));
			labels.push('<i  style=" background:rgba(252,255,128,1);border-color:rgba(83,147,92,1);"></i> '+numeral(1).format('0,0')+' - '+numeral(val[2]).format('0,0'));
		}
